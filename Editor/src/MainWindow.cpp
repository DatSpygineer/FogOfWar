...
namespace fow {
    ...
    void MainWindow::setupFileMenu() {
        ...
        m_pFileMenuEditorSettings->setIcon(LoadEditorIcon("icons/menu/settings_small.png"));
        m_pFileMenu->addAction(m_pFileMenuEditorSettings);
        m_pFileExit = new QAction("Exit", this);
        m_pFileExit->setIcon(LoadEditorIcon("icons/menu/exit_small.png"));
    ...
    void MainWindow::setupEditMenu() {
        ...
        m_pMenuEditUndo = m_pMenuEdit->addAction(LoadEditorIcon("icons/menu/undo_small.png"), "Undo");
        m_pMenuEditUndo->setEnabled(false);
        m_pMenuEditRedo = m_pMenuEdit->addAction(LoadEditorIcon("icons/menu/redo_small.png"), "Redo");
        m_pMenuEditRedo->setEnabled(false);
        m_pMenuEdit->addSeparator();
        m_pMenuEditCopy = m_pMenuEdit->addAction(LoadEditorIcon("icons/menu/copy_small.png"), "Copy");
        m_pMenuEditCopy->setEnabled(false);
        m_pMenuEditCut = m_pMenuEdit->addAction(LoadEditorIcon("icons/menu/cut_small.png"), "Cut");
        m_pMenuEditCut->setEnabled(false);
        m_pMenuEditPaste = m_pMenuEdit->addAction(LoadEditorIcon("icons/menu/paste_small.png"), "Paste");
        m_pMenuEditPaste->setEnabled(false);
        m_pMenuEdit->addSeparator();
        m_pMenuEditObjectProperties = m_pMenuEdit->addAction(LoadEditorIcon("icons/menu/properties_small.png"), "Object Properties");
        m_pMenuEditObjectProperties->setEnabled(false);
        m_pMenuEditMapProperties = m_pMenuEdit->addAction(LoadEditorIcon("icons/menu/map_properties_small.png"), "Map Properties");
    }
    void MainWindow::setupViewMenu() {
        m_pMenuView  = menuBar()->addMenu("&View");
        m_pMenuViewToggleWireframe = m_pMenuView->addAction(LoadEditorIcon("icons/menu/show_wireframe.png"), "Toggle wireframe");
        m_pMenuViewToggleWireframe->setCheckable(true);
        m_pMenuView->addSeparator();
        m_pMenuViewToggleGrid = m_pMenuView->addAction(LoadEditorIcon("icons/menu/show_grid_small.png"), "Toggle grid");
        m_pMenuViewToggleGrid->setCheckable(true);
        m_pMenuViewToggleBlockingTiles = m_pMenuView->addAction(LoadEditorIcon("icons/menu/show_blocking_small.png"), "Toggle passability display");
    ...
    void MainWindow::setupToolsMenu() {
        ...
        m_pMenuToolsEditPacks = m_pMenuTools->addAction(LoadEditorIcon("icons/menu/gamedata_small.png"), "Asset pack editor");
        m_pMenuToolsValidateMap = m_pMenuTools->addAction(LoadEditorIcon("icons/menu/validate_small.png"), "Validate map");
        connect(m_pMenuToolsEditPacks, &QAction::triggered, this, &MainWindow::showAssetPackEditor);
    }
    void MainWindow::setupToolbar() {
        m_pToolBar = new QToolBar(this);
        m_pToolBarNew = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/new_large.png"), "New Map..");
        m_pToolBarOpen = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/open_large.png"), "Open Map..");
        m_pToolBarSave = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/save_large.png"), "Save Map");
        m_pToolBarSave->setEnabled(false);
        m_pToolBarSaveAs = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/save_as_large.png"), "Save Map as..");
        m_pToolBarSaveAs->setEnabled(false);
        m_pToolBar->addSeparator();
        m_pToolBarCopy = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/copy_large.png"), "Copy");
        m_pToolBarCopy->setEnabled(false);
        m_pToolBarCut = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/cut_large.png"), "Cut");
        m_pToolBarCut->setEnabled(false);
        m_pToolBarPaste = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/paste_large.png"), "Paste");
        m_pToolBarPaste->setEnabled(false);
        m_pToolBarProperties = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/properties_large.png"), "Object Properties");
        m_pToolBarProperties->setEnabled(false);
        m_pToolBar->addSeparator();
        m_pToolBarToggleWireframe = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/show_wireframe.png"), "Toggle wireframe");
        m_pToolBarToggleWireframe->setCheckable(true);
        m_pToolBarToggleGrid = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/show_grid.png"), "Toggle grid");
        m_pToolBarToggleGrid->setCheckable(true);
        m_pToolBarToggleBlockedTiles = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/show_blocked_tiles.png"), "Toggle passability display");
        m_pToolBarToggleBlockedTiles->setCheckable(true);
        m_pToolBarValidate = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/validate.png"), "Validate map");
        m_pToolBar->addSeparator();
        m_pToolBarUndo = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/undo.png"), "Undo");
        m_pToolBarUndo->setEnabled(false);
        m_pToolBarRedo = m_pToolBar->addAction(LoadEditorIcon("icons/toolbar/redo.png"), "Redo");
