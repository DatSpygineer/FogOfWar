...
namespace fow {
    ...
    namespace Renderer {
        ...
        FOW_RENDER_API void UpdateCameraProjectionMatrix(const Matrix4& matrix);
        ...
        FOW_RENDER_API void UpdateCameraProjectionPerspective(float fov, const Vector2& size, float near, float far);
